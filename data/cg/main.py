...
ti.init(arch=ti.gpu, default_fp=ti.f64, kernel_profiler=True, device_memory_GB=8)  # Use device_memory_GB=X to allocate more memory if necessary
...
for psize in problem_size:
    ...
    assert(residual_cg < 1e-4)  # See reference: https://en.wikipedia.org/wiki/Conjugate_gradient_method
