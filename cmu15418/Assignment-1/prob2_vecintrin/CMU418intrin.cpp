...
__cmu418_mask _cmu418_mask_xor(__cmu418_mask &maska, __cmu418_mask &maskb) {
    __cmu418_mask resultMask;
    for (int i = 0; i < VECTOR_WIDTH; i++) {
        resultMask.value[i] = maska.value[i] ^ maskb.value[i];
    }
    CMU418Logger.addLog("maskxor", _cmu418_init_ones(), VECTOR_WIDTH);
    return resultMask;
}
...
// vset
template <typename T> void _cmu418_vset(__cmu418_vec<T> &vecResult, T value, __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++) {
...
// vmove
template <typename T> void _cmu418_vmove(__cmu418_vec<T> &dest, __cmu418_vec<T> &src, __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++) {
...
// vload
template <typename T> void _cmu418_vload(__cmu418_vec<T> &dest, T *src, __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++) {
...
// vstore
template <typename T> void _cmu418_vstore(T *dest, __cmu418_vec<T> &src, __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++) {
...
void _cmu418_vshiftright_int(__cmu418_vec_int &vecResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
    ...
    CMU418Logger.addLog("vshiftright", mask, VECTOR_WIDTH);
}
...
// vabs
template <typename T> void _cmu418_vabs(__cmu418_vec<T> &vecResult, __cmu418_vec<T> &veca, __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++) {
...
// hadd
template <typename T> void _cmu418_hadd(__cmu418_vec<T> &vecResult, __cmu418_vec<T> &vec) {
...
// interleave
template <typename T> void _cmu418_interleave(__cmu418_vec<T> &vecResult, __cmu418_vec<T> &vec) {
    for (int i = 0; i < VECTOR_WIDTH; i++) {
